...
The data frame is called `evals` and is contained in the **openintro** package (you can read more about it <a href="https://www.openintro.org/data/index.php?data=evals"> here</a>). 

We can view the first few lines of the data running the `head` function. 
...
Create a boxplot of `score` against `rank` to explore any relationship.
...
**Which of the boxplots has the largest spread?**
